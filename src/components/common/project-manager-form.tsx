        ...
        {preview ? (
          <div className="relative">
            ...
            <button
              ...
              className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-card border border-border/50 text-muted-foreground transition-colors hover:bg-destructive hover:text-white hover:border-destructive"
            >
              <X className="h-3 w-3" />
            </button>
          </div>
